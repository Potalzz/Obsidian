...
3. 날아오는 공에 맞춰서 손을 가져다 댄다
4. 공에 맞게 글러브를 가져다 대고 공이 도착하는 타이밍에 맞게 손을 움켜지면 공을 잡는다
	1. 공에 위치에 맞게 글러브를 가져다 대었지만, 타이밍에 맞게 움켜지지 않으면 공이 글러브에서 떨어진다.
	2. 공에 위치에 글러브 모서리 부분이 맞으면 공이 글러브에 맞고 공이 떨어진다.
	3. 공에 위치에 글러브를 가져다 대지 못하면 공이 그냥 지나간다.
