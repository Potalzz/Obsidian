...
![[../../../assets/images/Pasted image 20250830180401.png]]
ECS의 전체적인 구조
...
![[../../../assets/images/Pasted image 20250830200947.png]]
(Shared Space 공간)
...
![[../../../assets/images/Pasted image 20250830201038.png]]
...
![[../../../assets/images/Pasted image 20250830205002.png]]
...
![[../../../assets/images/Pasted image 20250830185400.png]]


### Volume
`Model3D`를 통해서 앱에서 3D 콘텐츠를 간단하게 추가할 수 있다.
![[../../../assets/images/Pasted image 20250830185611.png]]

`Model3D`는 로딩하는데 시간이 걸리기 때문에 이미지와 달리 비동기적으로 작동한다.

![[../../../assets/images/Pasted image 20250830185901.png]]
...
![[../../../assets/images/Pasted image 20250830205210.png]]
`passthrough`를 어둡게 설정하여 공간 콘텐츠에 더 집중되도록 만들 수 있다.

`Immersive Space`에서 현실 손을 비활성화하고 가상 손을 띄울 수 있다.

![[../../../assets/images/Pasted image 20250830205350.png]]
(현실 손을 비활성화 한다)

![[../../../assets/images/Pasted image 20250830205445.png]]
(가상 손을 불러오고 루트의 자식으로 추가해준다)

![[../../../assets/images/Pasted image 20250830205731.png]]
(ARKit와 손 추적 API를 사용하고, handTracking시스템을 시작해야 한다)

![[../../../assets/images/Pasted image 20250830205836.png]]
...
![[../../../assets/images/Pasted image 20250830210115.png]]
다시 `ImmersiveSpace`로 돌아가서 가상 손을 추가해주면 된다.

![[../../../assets/images/Pasted image 20250830210244.png]]
실제 손이 가상 글러브로 바뀐 모습
...
![[../../../assets/images/Pasted image 20250913191828.png]]
업데이트는 데이터 유형에 따라 다른 주파수에서 비동기적으로 들어온다.


### ARKit에서 카메라로 얻은 데이터는 접근할 수 없다.
![[../../../assets/images/Pasted image 20250913184015.png]]
...
- 일부 유형의 ARKit 데이터는 접근 권한을 요구한다.![[../../../assets/images/Pasted image 20250913184205.png]]
...
Plane의 종류에 따라서 분류한다.
![[../../../assets/images/Pasted image 20250913200221.png]]
[표면의 종류] 


#### Scene geometry
![[../../../assets/images/Pasted image 20250913200341.png]]
[Scene geometry 인식]
...
![[../../../assets/images/Pasted image 20250913210813.png]]
[MechAnchor의 구성]

![[../../../assets/images/Pasted image 20250913210856.png]]
[Mesh의 분류 종류]
...
![[../../../assets/images/Pasted image 20250914003706.png]]
...
![[../../../assets/images/Pasted image 20250914033007.png]]
...
`HandAnchor`는 두 가지 방법으로 가져올 수 있다.
1. 필요한 시점에 최신 손 위치 및 상태(HandAnchors) 데이터를 **요청**하여 가져오는 방식
...
![[../../../assets/images/Pasted image 20250927005512.png]]
...
![[../../../assets/images/Pasted image 20250927005953.png]]
앱 렌더링 영역 설정하여 벗어나는 경우 자연스럽게 사라지는 효과 구현

![[../../../assets/images/Pasted image 20250927010009.png]]


![[../../../assets/images/Pasted image 20250927010222.png]]
